...
resource existingvmss 'Microsoft.Compute/virtualMachineScaleSets@2024-03-01' existing = {
  name: name
}

resource vmss_diagnostics 'Microsoft.Compute/virtualMachineScaleSets/extensions@2024-03-01' = {
  name: name
  properties: {
    ...
    typeHandlerVersion: '4.1'
    settings: {
      StorageAccount: 'eastusworklogs'
      ladCfg: {
